...
import { journeyModel, type Item, type JourneyData } from '../quest/model'
...
function prepare(q: JourneyData): JourneyData {
  let n = 0
...
export default function MockPage() {
  ...
  const model = useMemo(() => journeyModel(prepare(maps[slug] ?? maps['winter-update'])), [slug])
  ...
  return (
    <>
      <JourneyMap model={model} atlasHref="/mock" lineTypes={lineTypes} />
